...
// MF can't seem to find the collections framework libraries being loaded
import java.util.Enumeration;
import java.util.NoSuchElementException;
import java.util.Random;

// replaced by MF to figure out where the collections framework is
//import java.util.* ;
...
public abstract class MaskFactoryNEW implements Enumeration  {
    ...
    public MaskFactoryNEW( int cellsInRow ) {
        resize( cellsInRow );
//        initiate( false );
    }
